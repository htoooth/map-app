  ...
  methods: {
    click(e, ctx) {
      const name = e.name;
          ...
          this._setSumenuDisabledStatus(actionTypes.EDITOR_EDIT_MODE_START, true);
          this._setSumenuDisabledStatus(actionTypes.EDITOR_EDIT_MODE_SAVE, false);
          this._setSumenuDisabledStatus(actionTypes.EDITOR_EDIT_MODE_END, false);
					break;
				}
          ...
          this._setSumenuDisabledStatus(actionTypes.EDITOR_EDIT_MODE_START, false);
          this._setSumenuDisabledStatus(actionTypes.EDITOR_EDIT_MODE_SAVE, true);
    ...
    _findMenuByName(name) {
      let menu = util.findInArrays((i) => i.name === name,
  ...
  render() {
    return (
      <easyui-toolbar title="编辑工具栏">
        ...
        <easyui-menubutton ref="select" title="修改" opts={this.config.modify.opts} clicksubmenu={this.click}>
          <easyui-menu submenu={this.config.modify.submenu}></easyui-menu>
        </easyui-menubutton>
